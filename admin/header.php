   ...
   <div class="header-wrapper row m-0">
      ...
      <div class="left-header col horizontal-wrapper ps-0">
         <ul class="horizontal-menu">
            <li class="mega-menu outside"><a class="nav-link" href="#!"><i data-feather="layers"></i><span>Reports</span></a>
                     ...
                     <div class="row">
                        <div class="col mega-box">
                           ...
                           <div class="link-section icon">
                              ...
                              <ul>
                                 ...
                                 <li><a href="javascript:;">Management Letter</a></li>
                                 <li><a href="javascript:;">Archive</a></li>
                                 <li><a href="javascript:;">Security & Humas</a></li>
                                 <li><a href="javascript:;">Customer Services</a></li>
                        ...
                        <div class="col mega-box">
                           ...
                           <div class="link-section icon">
                              ...
                              <ul>
                                 <li><a href="javascript:;">Quary</a></li>
                                 <li><a href="javascript:;">AMP</a></li>
                                 <li><a href="javascript:;">STC</a></li>
                                 <li><a href="javascript:;">Laboratory</a></li>
                                 <li><a href="javascript:;">Logistics & Transportation</a></li>
                                 <li><a href="javascript:;">Workhsop</a></li>
                                 <li><a href="javascript:;">Warehouse</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
            ...
            <li class="level-menu outside"><a class="nav-link" href="#!"><i data-feather="inbox"></i><span>Module</span></a>
               <ul class="header-level-menu menu-to-be-close">
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="file"></i><span>Administration</span></a></li>
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="users"></i><span>Operations</span></a>
                     <ul class="header-level-sub-menu">
                        <li><a href="javascript:;" data-original-title="" title=""> <span>Production</span></a></li>
                        <li><a href="javascript:;" data-original-title="" title=""> <span>Workshop</span></a></li>
                        <li><a href="javascript:;" data-original-title="" title=""><span>Quality Control</span></a></li>
                        <li><a href="javascript:;" data-original-title="" title=""> <span>Warehouse</span></a></li>
                     </ul>
                  </li>
                  <li><a href="bookmark.html" data-original-title="" title=""> <i data-feather="monitor"></i><span>Accounting</span></a></li>
                  <li><a href="bookmark.html" data-original-title="" title=""> <i data-feather="box"></i><span>Project</span></a></li>
                  <li><a href="bookmark.html" data-original-title="" title=""> <i data-feather="user"></i><span>Internal Audits</span></a></li>
               </ul>
            </li>
         </ul>
      </div>
         ...
         <ul class="nav-menus">
            ...
            <li class="cart-nav onhover-dropdown">
               ...
               <ul class="cart-dropdown onhover-show-div">
                  <li>
                     <h6 class="mb-0 f-20">Purchase Order</h6><i data-feather="shopping-cart"></i>
                  </li>
                  <li class="mt-0">
                  ...
                  <li><a class="btn btn-block w-100 mb-2 btn-primary view-cart" href="javascript:;">Go to shoping bag</a><a class="btn btn-block w-100 btn-secondary view-cart" href="javascript:;">Checkout</a></li>
               </ul>
            </li>
            ...
            <li class="profile-nav onhover-dropdown p-0 me-0">
               <div class="media profile-media"><img class="b-r-10" src="../assets/images/dashboard/profile.jpg" alt="">
                  <div class="media-body"><span>ImZack Dev</span>
               ...
               <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li><a href="javascript:;"><i data-feather="log-in"> </i><span>Log Out</span></a></li>
               </ul>
            </li>
         </ul>
      </div>
